  ...
  return (
    <div className="flex items-center justify-between gap-3
      ...
      <div className="flex items-center gap-2.5 min-w-0">
        <FileCode2 size={15} className="shrink-0 text-blue-500 dark:text-blue-400" />
        <span className="text-slate-700 dark:text-slate-200 truncate font-mono text-xs">{file.name}</span>
      </div>
      <div className="flex items-center gap-2 shrink-0">
        <span className="text-xs text-slate-400 dark:text-slate-600">{kb} KB</span>
        <button
          type="button"
          onClick={onRemove}
          className="p-0.5 rounded-md text-slate-400 dark:text-slate-600 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-500/10 transition-all"
        >
          <X size={13} />
        </button>
      </div>
    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">Ingestão de Esquemas TISS</h1>
        ...
        <form
          ...
          className="bg-white dark:bg-slate-900/60 backdrop-blur-xl
              ...
              <div
                ...
                className={[
                  ...
                  isDragging
                    ...
                    : 'border-slate-200 dark:border-slate-700/60 hover:border-slate-400 dark:hover:border-slate-600/80 hover:bg-slate-50 dark:hover:bg-white/[0.02]',
                  loading ? 'pointer-events-none opacity-60' : '',
                ].join(' ')}
              >
                <div className={[
                  'w-12 h-12 rounded-xl flex items-center justify-center transition-colors duration-200',
                  isDragging ? 'bg-blue-500/20' : 'bg-slate-100 dark:bg-slate-800/80',
                ].join(' ')}>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-400 dark:text-slate-600 mt-0.5">Aceita .xsd e .xml · múltiplos arquivos</p>
                </div>
                <button
                  type="button"
            ...
            <button
              ...
              className={[
                ...
                loading || !version.trim() || files.length === 0
                  ? 'bg-slate-100 dark:bg-slate-800/60 text-slate-400 dark:text-slate-600 cursor-not-allowed border border-slate-200 dark:border-slate-700/40'
        ...
        {/* Info card */}
        <div className="mt-4 bg-slate-50 dark:bg-slate-900/40
                        border border-slate-200 dark:border-slate-800/40
                        rounded-xl px-5 py-4 flex items-start gap-3 text-xs text-slate-500 dark:text-slate-500">
          <FileCode2 size={14} className="shrink-0 mt-0.5 text-slate-400 dark:text-slate-600" />
          <p>
