...
import {
  ...
  Users, Package, ScrollText, FileCode2, Network, Sparkles, Wrench, ScanSearch, Code2, GitCompare, Settings, ListChecks, ShieldCheck,
} from 'lucide-react';
...
const TOOLS_NAV = [
  ...
  { to: '/tools/tiss-validator',        icon: ShieldCheck, label: 'Validador TISS'             },
];
